...
<div class="w3-container">
        ...
        <form action="AddUpdatedHealthCenterToDb.jsp" style="width: 40%; background-color: white;border: 1px solid whitesmoke; padding: 10px;box-shadow: 
        ...
        <div style="display: flex;align-items: center; justify-content: center;">
            ...
            <div class="m-3">
                ...
                <input type="text" class="form-control" name="healthCenterName" value="<%=newValues[0]%>">
            </div>

              <div class="m-3">
                <label for="exampleFormControlInput1" class="form-label">No Of Patients:</label>
                <input type="number" class="form-control m-2" name="totalPatients" value="<%=newValues[1] %>">
              </div>
              ...
              <div class="m-3 "  style="margin:20px 0;">
                  <button type="submit" class="btn btn-primary pt-3 m-2 btn-block">Update Health center</button>
              </div>
