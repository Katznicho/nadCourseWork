...
public class RegisterHealthCenterHandler extends SimpleTagSupport {
    ...
    public void doTag() throws JspException {
        ...
        try {
          ...
          //St.execute("INSERT INTO `healthcenter` (`vaccineId`, `totalNumber`, `type`, `status`) "
                 ...
                 St.execute("VALUES ('1', 'mulago', '10', '10', '2021-12-01', 'december', 'phizer');" 
          + "INSERT INTO `healthcentres` (`healthCenterId`, `healthCenterName`, `totalPatients`, `totalVaccines`, "
                         + "`receiveDate`,"
                         + "`receiveMonth`, `vaccineName`)");
